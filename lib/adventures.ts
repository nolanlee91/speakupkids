...
/* ============================================================================
 * SEASON 08 — MISSION MOONBASE
 * Team roles → constrained cargo → safety sequence → route choice →
 * precise delayed communication → evidence-based habitat decision.
 * ==========================================================================*/
const H = "/assets/images/adventure/season-08-mission-moonbase/";

const S08_ITEMS: AdventureItem[] = [
  { id: "moon-mission-pass", name: "Moon Mission Pass", vi: "Thẻ nhiệm vụ Mặt Trăng", emoji: "🎟️", image: H + "items/moon-mission-pass.webp" },
  { id: "crew-role-cards", name: "Crew Role Cards", vi: "Bộ thẻ vai trò", emoji: "🃏", image: H + "items/crew-role-cards.webp" },
  { id: "cargo-manifest", name: "Cargo Manifest", vi: "Bảng kê hàng nhiệm vụ", emoji: "📋", image: H + "items/cargo-manifest.webp" },
  { id: "airlock-access-key", name: "Airlock Access Key", vi: "Chìa khóa buồng khí", emoji: "🗝️", image: H + "items/airlock-access-key.webp" },
  { id: "rover-route-map", name: "Rover Route Map", vi: "Bản đồ tuyến xe rover", emoji: "🗺️", image: H + "items/rover-route-map.webp" },
  { id: "communication-beacon", name: "Communication Beacon", vi: "Đèn hiệu liên lạc", emoji: "📡", image: H + "items/communication-beacon.webp" },
  { id: "lunar-sample-container", name: "Lunar Sample Container", vi: "Hộp mẫu đá Mặt Trăng", emoji: "🪨", image: H + "items/lunar-sample-container.webp" },
  { id: "habitat-decision-report", name: "Habitat Decision Report", vi: "Báo cáo vị trí nhà kính", emoji: "📊", image: H + "items/habitat-decision-report.webp" },
  { id: "lunar-mission-specialist-badge", name: "Lunar Mission Specialist Badge", vi: "Huy hiệu Chuyên gia Nhiệm vụ Mặt Trăng", emoji: "🏅", image: H + "items/lunar-mission-specialist-badge.webp" },
];

const S08_CHAPTERS: AdventureChapter[] = [
  {
    id: "s08-ch01", seasonId: "s08", chapterNumber: 1,
    title: "The Crew Briefing", vi: "Buổi phân công nhiệm vụ",
    shortDescription: "Maple đọc hồ sơ kỹ năng và phân công navigator, engineer, scientist và communicator cho đúng nhiệm vụ.",
    estimatedMinutes: 6,
    node: { x: 17, y: 73, key: "command-dome" },
    sceneImage: H + "chapters/chapter-01-crew-briefing.webp",
    nextChapterId: "s08-ch02",
    reward: {
      stars: 3, itemId: "crew-role-cards", extraItemIds: ["moon-mission-pass"],
      clueTitle: "Crew Role Cards",
      clueVi: "Bốn thẻ xác định rõ ai phụ trách điều hướng, kỹ thuật, khoa học và liên lạc.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Commander Reyes",
        en: "A strong crew does not give every task to the same person. Match each responsibility to the skill it needs.",
        vi: "Một đội tốt không giao mọi nhiệm vụ cho cùng một người. Hãy ghép từng trách nhiệm với kỹ năng cần thiết." },
      { kind: "observation",
        prompt: "Which four role symbols appear on the command console?",
        vi: "Bốn biểu tượng vai trò nào xuất hiện trên bàn điều khiển?",
        options: [
          { label: "A map, wrench, science flask, and antenna", correct: true, feedback: "Đúng! Chúng đại diện cho điều hướng, kỹ thuật, khoa học và liên lạc." },
          { label: "A boat, tree, camera, and lantern", correct: false, feedback: "Đó là đồ vật từ các mùa trước, không phải vai trò phi hành đoàn." },
          { label: "Four identical maps", correct: false, feedback: "Mỗi thẻ có một biểu tượng kỹ năng khác nhau." },
        ] },
      { kind: "multipleChoice",
        prompt: "Who should compare the two rover routes?",
        vi: "Ai nên so sánh hai tuyến đường của xe rover?",
        options: ["The navigator", "The scientist", "The communicator"],
        answer: "The navigator",
        explainVi: "Navigator chịu trách nhiệm đọc bản đồ, địa hình và lựa chọn tuyến." },
      { kind: "multipleChoice",
        prompt: "Who should inspect the airlock seal and pressure controls?",
        vi: "Ai nên kiểm tra gioăng và bộ điều khiển áp suất của buồng khí?",
        options: ["The engineer", "The navigator", "The reporter"],
        answer: "The engineer",
        explainVi: "Kiểm tra hệ thống cơ khí và điều khiển thuộc trách nhiệm kỹ thuật." },
      { kind: "arrangeSentence",
        prompt: "Assign a role clearly:",
        vi: "Phân công vai trò rõ ràng:",
        solution: ["The", "scientist", "will", "study", "the", "lunar", "samples"],
        say: "The scientist will study the lunar samples.",
        explainVi: "Will + động từ nguyên mẫu diễn đạt nhiệm vụ được giao trong kế hoạch." },
      { kind: "clueReveal", title: "Crew Role Cards", itemId: "crew-role-cards",
        en: "Commander Reyes approves the assignments and gives Maple a mission pass. The crew heads to the cargo bay.",
        vi: "Chỉ huy Reyes duyệt phân công và trao Maple thẻ nhiệm vụ. Cả đội đi tới khoang hàng." },
    ],
  },
  {
    id: "s08-ch02", seasonId: "s08", chapterNumber: 2,
    title: "The Cargo Limit", vi: "Giới hạn khoang hàng",
    shortDescription: "Xe rover không thể chở mọi thứ. Maple phải ưu tiên nước, oxy, y tế và dụng cụ khoa học trước các món không thiết yếu.",
    estimatedMinutes: 7,
    node: { x: 31, y: 43, key: "cargo-bay" },
    sceneImage: H + "chapters/chapter-02-cargo-limit.webp",
    nextChapterId: "s08-ch03",
    reward: {
      stars: 3, itemId: "cargo-manifest",
      clueTitle: "Cargo Manifest",
      clueVi: "Bảng kê ưu tiên tài nguyên sống còn, bộ y tế và dụng cụ nhiệm vụ trong giới hạn tải.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Commander Reyes",
        en: "The rover has limited capacity. Essential supplies must be loaded before comfort or entertainment items.",
        vi: "Xe rover có tải trọng giới hạn. Vật dụng thiết yếu phải được xếp trước đồ tiện nghi hoặc giải trí." },
      { kind: "observation",
        prompt: "Which cargo modules show life-support resources?",
        vi: "Những module hàng nào thể hiện tài nguyên duy trì sự sống?",
        options: [
          { label: "Water and oxygen", correct: true, feedback: "Đúng! Biểu tượng giọt nước và bình oxy là tài nguyên sống còn." },
          { label: "Cushions and a speaker", correct: false, feedback: "Đây là đồ tiện nghi và giải trí, không phải hệ thống sống còn." },
          { label: "Only the science tools", correct: false, feedback: "Dụng cụ khoa học quan trọng nhưng không thay thế nước và oxy." },
        ] },
      { kind: "multipleChoice",
        prompt: "If only one space remains after water and oxygen, which item should be loaded for safety?",
        vi: "Nếu chỉ còn một chỗ sau nước và oxy, vật nào nên được xếp để đảm bảo an toàn?",
        options: ["The medical kit", "The decorative cushions", "The large speaker"],
        answer: "The medical kit",
        explainVi: "Bộ y tế hỗ trợ xử lý sự cố sức khỏe nên được ưu tiên trước đồ không thiết yếu." },
      { kind: "arrangeSentence",
        prompt: "Explain the priority:",
        vi: "Giải thích thứ tự ưu tiên:",
        solution: ["We", "must", "load", "oxygen", "before", "the", "speaker"],
        say: "We must load oxygen before the speaker.",
        explainVi: "Must diễn đạt yêu cầu bắt buộc; before xác định thứ tự." },
      { kind: "multipleChoice",
        prompt: "Why is the cheapest or lightest item not always the best choice?",
        vi: "Vì sao món rẻ nhất hoặc nhẹ nhất không phải lúc nào cũng là lựa chọn tốt nhất?",
        options: ["Mission value and safety also matter", "All cargo has the same purpose", "Weight bars are only decoration"],
        answer: "Mission value and safety also matter",
        explainVi: "Quyết định trong giới hạn cần cân bằng trọng lượng với nhu cầu, rủi ro và mục tiêu." },
      { kind: "clueReveal", title: "Cargo Manifest", itemId: "cargo-manifest",
        en: "The essential cargo fits within the capacity bar. The next checklist waits inside the airlock.",
        vi: "Hàng thiết yếu vừa với thanh tải trọng. Danh sách kiểm tra tiếp theo đang chờ trong buồng khí." },
    ],
  },
  {
    id: "s08-ch03", seasonId: "s08", chapterNumber: 3,
    title: "Through the Airlock", vi: "Đi qua buồng khí",
    shortDescription: "Maple phải hoàn thành đúng quy trình mũ bảo hộ, khóa đồ, đóng cửa trong và cân bằng áp suất trước khi mở cửa ngoài.",
    estimatedMinutes: 7,
    node: { x: 43, y: 48, key: "airlock" },
    sceneImage: H + "chapters/chapter-03-through-airlock.webp",
    nextChapterId: "s08-ch04",
    reward: {
      stars: 3, itemId: "airlock-access-key",
      clueTitle: "Airlock Access Key",
      clueVi: "Chìa khóa chỉ kích hoạt sau khi toàn bộ trình tự an toàn được hoàn thành đúng thứ tự.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Dr. Sato",
        en: "An airlock sequence protects both the crew and the habitat. Never open the outer door while the inner door is open.",
        vi: "Quy trình buồng khí bảo vệ cả phi hành đoàn và căn cứ. Không bao giờ mở cửa ngoài khi cửa trong đang mở." },
      { kind: "observation",
        prompt: "What is the first action shown on the safety panel?",
        vi: "Hành động đầu tiên trên bảng an toàn là gì?",
        options: [
          { label: "Secure the helmet", correct: true, feedback: "Đúng! Hình đầu cho thấy hai tay đang cố định mũ." },
          { label: "Open the outer door", correct: false, feedback: "Cửa ngoài chỉ mở sau khi khóa đồ và cân bằng áp suất." },
          { label: "Drive the rover", correct: false, feedback: "Xe rover không nằm trong quy trình buồng khí." },
        ] },
      { kind: "multipleChoice",
        prompt: "What must happen after the inner door closes but before the outer door opens?",
        vi: "Điều gì phải xảy ra sau khi cửa trong đóng nhưng trước khi cửa ngoài mở?",
        options: ["The pressure must be equalized", "The cargo must be unpacked", "The crew must change roles"],
        answer: "The pressure must be equalized",
        explainVi: "Bảng trình tự cho thấy bước đồng hồ áp suất nằm giữa đóng cửa trong và mở cửa ngoài." },
      { kind: "arrangeSentence",
        prompt: "State the safety sequence:",
        vi: "Nêu trình tự an toàn:",
        solution: ["Check", "the", "seal", "before", "you", "open", "the", "outer", "door"],
        say: "Check the seal before you open the outer door.",
        explainVi: "Mệnh đề với before cho biết việc bắt buộc phải hoàn thành trước." },
      { kind: "multipleChoice",
        prompt: "Why should the crew follow the same checklist every time?",
        vi: "Vì sao đội nên dùng cùng một checklist mỗi lần?",
        options: ["A repeatable sequence reduces missed safety steps", "It makes the Moon brighter", "It removes the need for an engineer"],
        answer: "A repeatable sequence reduces missed safety steps",
        explainVi: "Checklist tiêu chuẩn giảm phụ thuộc vào trí nhớ và giúp phát hiện bước còn thiếu." },
      { kind: "clueReveal", title: "Airlock Access Key", itemId: "airlock-access-key",
        en: "All indicators turn green and the access key releases. Maple can now join the rover team outside.",
        vi: "Mọi đèn chỉ báo chuyển xanh và chìa khóa được nhả ra. Maple có thể tham gia đội rover bên ngoài." },
    ],
  },
  {
    id: "s08-ch04", seasonId: "s08", chapterNumber: 4,
    title: "The Rover Route", vi: "Tuyến đường xe rover",
    shortDescription: "Đường ngắn đi sát hố tối và dốc, trong khi đường dài hơn có nắng, địa hình bằng và ba mốc đá rõ ràng.",
    estimatedMinutes: 7,
    node: { x: 61, y: 66, key: "rover-valley" },
    sceneImage: H + "chapters/chapter-04-rover-route.webp",
    nextChapterId: "s08-ch05",
    reward: {
      stars: 3, itemId: "rover-route-map", extraItemIds: ["lunar-sample-container"],
      clueTitle: "Rover Route Map",
      clueVi: "Bản đồ đánh dấu tuyến có nắng và bằng phẳng, đủ năng lượng để tới điểm lấy mẫu và quay về.",
    },
    storySteps: [
      { kind: "dialogue", who: "maple",
        en: "The shortest route crosses a steep shadowed edge. The longer route stays in sunlight and follows three visible rock markers.",
        vi: "Tuyến ngắn nhất đi qua mép dốc trong bóng tối. Tuyến dài hơn ở trong nắng và theo ba mốc đá nhìn thấy rõ." },
      { kind: "observation",
        prompt: "Which route passes the three circular rock markers?",
        vi: "Tuyến nào đi qua ba mốc đá hình tròn?",
        options: [
          { label: "The sunlit yellow route", correct: true, feedback: "Đúng! Tuyến vàng đi qua các mốc tròn trên địa hình bằng hơn." },
          { label: "The shadowed route beside the crater", correct: false, feedback: "Tuyến đó chạy gần mép hố và không theo ba mốc an toàn." },
          { label: "Neither route", correct: false, feedback: "Hãy nhìn đường vàng và các vòng tròn dọc theo nó." },
        ] },
      { kind: "multipleChoice",
        prompt: "Why can the longer sunlit route still be the better choice?",
        vi: "Vì sao tuyến có nắng dài hơn vẫn có thể là lựa chọn tốt hơn?",
        options: ["It reduces terrain risk and supports rover energy", "Long routes are always faster", "Shadows make maps inaccurate"],
        answer: "It reduces terrain risk and supports rover energy",
        explainVi: "Lựa chọn tuyến không chỉ dựa vào khoảng cách mà còn độ dốc, tầm nhìn và năng lượng." },
      { kind: "arrangeSentence",
        prompt: "Recommend the route:",
        vi: "Đề xuất tuyến đường:",
        solution: ["We", "should", "take", "the", "sunlit", "route", "because", "it", "is", "safer"],
        say: "We should take the sunlit route because it is safer.",
        explainVi: "Should đưa ra khuyến nghị; because giới thiệu lý do." },
      { kind: "multipleChoice",
        prompt: "What should the crew confirm before leaving the sample site?",
        vi: "Đội nên xác nhận điều gì trước khi rời điểm lấy mẫu?",
        options: ["Enough energy remains for the return trip", "The route is the shortest on paper", "Every rock has the same colour"],
        answer: "Enough energy remains for the return trip",
        explainVi: "Kế hoạch an toàn phải tính cả hành trình quay về, không chỉ tới đích." },
      { kind: "clueReveal", title: "Lunar Sample Container", itemId: "lunar-sample-container",
        en: "The rover reaches the site safely and collects three sealed samples. The crew must report its route through the delayed link.",
        vi: "Xe rover tới điểm an toàn và thu ba mẫu được niêm phong. Đội phải báo tuyến đường qua liên kết có độ trễ." },
    ],
  },
  {
    id: "s08-ch05", seasonId: "s08", chapterNumber: 5,
    title: "The Delayed Message", vi: "Thông điệp bị trễ",
    shortDescription: "Liên lạc với Trái Đất không diễn ra tức thì. Maple phải gửi một thông điệp đủ vị trí, tuyến, năng lượng và thời gian dự kiến.",
    estimatedMinutes: 7,
    node: { x: 66, y: 23, key: "communication-tower" },
    sceneImage: H + "chapters/chapter-05-delayed-message.webp",
    nextChapterId: "s08-ch06",
    reward: {
      stars: 3, itemId: "communication-beacon",
      clueTitle: "Communication Beacon",
      clueVi: "Đèn hiệu gửi bản cập nhật ngắn nhưng đầy đủ để trung tâm hiểu tình trạng mà không phải hỏi lại.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Noah",
        en: "Mission control cannot reply immediately. Our first message should include every detail they need to understand our status.",
        vi: "Trung tâm không thể trả lời ngay. Thông điệp đầu tiên nên chứa mọi chi tiết họ cần để hiểu tình trạng." },
      { kind: "observation",
        prompt: "Which information appears on the complete message card?",
        vi: "Thông tin nào xuất hiện trên thẻ thông điệp đầy đủ?",
        options: [
          { label: "Location, route, energy, and arrival time", correct: true, feedback: "Đúng! Thẻ đầy đủ kết hợp bốn phần thông tin." },
          { label: "Only a rover and a question mark", correct: false, feedback: "Đó là thẻ mơ hồ, thiếu trạng thái và kế hoạch." },
          { label: "A list of crew favourite foods", correct: false, feedback: "Thông tin này không liên quan tới cập nhật tuyến rover." },
        ] },
      { kind: "multipleChoice",
        prompt: "Why is “The rover has a problem” an ineffective delayed message?",
        vi: "Vì sao câu “Xe rover có vấn đề” không hiệu quả khi liên lạc bị trễ?",
        options: ["It does not explain the problem, location, or requested action", "It is too polite", "It contains too many measurements"],
        answer: "It does not explain the problem, location, or requested action",
        explainVi: "Thông điệp mơ hồ tạo thêm vòng hỏi đáp và làm mất thời gian khi phản hồi không tức thì." },
      { kind: "arrangeSentence",
        prompt: "Send a clear update:",
        vi: "Gửi cập nhật rõ ràng:",
        solution: ["We", "are", "on", "the", "sunlit", "route", "with", "enough", "energy", "to", "return"],
        say: "We are on the sunlit route with enough energy to return.",
        explainVi: "Câu cung cấp cả vị trí hiện tại và trạng thái tài nguyên." },
      { kind: "multipleChoice",
        prompt: "What should the crew do after sending the message?",
        vi: "Đội nên làm gì sau khi gửi thông điệp?",
        options: ["Continue the safe plan while monitoring for a reply", "Stop all systems until Earth answers", "Send many conflicting versions"],
        answer: "Continue the safe plan while monitoring for a reply",
        explainVi: "Khi kế hoạch đã an toàn và thông tin đầy đủ, đội tiếp tục đồng thời theo dõi phản hồi." },
      { kind: "clueReveal", title: "Communication Beacon", itemId: "communication-beacon",
        en: "The complete update reaches Earth without a follow-up question. New data now supports the final greenhouse site decision.",
        vi: "Cập nhật đầy đủ tới Trái Đất mà không cần hỏi lại. Dữ liệu mới giờ hỗ trợ quyết định vị trí nhà kính cuối cùng." },
    ],
  },
  {
    id: "s08-ch06", seasonId: "s08", chapterNumber: 6,
    title: "The Habitat Decision", vi: "Quyết định vị trí căn cứ",
    shortDescription: "Maple so sánh ba địa điểm theo độ bằng phẳng, ánh sáng, nước băng và khoảng cách kết nối để chọn nơi xây nhà kính.",
    estimatedMinutes: 8,
    node: { x: 84, y: 48, key: "greenhouse-site" },
    sceneImage: H + "chapters/chapter-06-habitat-decision.webp",
    reward: {
      stars: 3, itemId: "habitat-decision-report", extraItemIds: ["lunar-mission-specialist-badge"],
      clueTitle: "Lunar Mission Specialist Badge",
      clueVi: "Maple chọn Site C vì cân bằng được ánh sáng, nước, năng lượng, địa hình và tuyến kết nối.",
    },
    storySteps: [
      { kind: "dialogue", who: "maple",
        en: "No site is perfect in only one way. The best site must balance sunlight, water access, level ground, energy, and connection distance.",
        vi: "Không địa điểm nào hoàn hảo chỉ theo một tiêu chí. Nơi tốt nhất phải cân bằng ánh sáng, nước, địa hình bằng, năng lượng và khoảng cách kết nối." },
      { kind: "observation",
        prompt: "Which panel shows strong water, energy, and sunlight indicators together?",
        vi: "Bảng nào cùng hiển thị mức nước, năng lượng và ánh sáng mạnh?",
        options: [
          { label: "Site C on the right", correct: true, feedback: "Đúng! Cả ba thanh ở Site C đều ở mức cao." },
          { label: "Site A on the left", correct: false, feedback: "Site A có nắng nhưng địa hình dốc và các chỉ báo khác thấp." },
          { label: "Site B in the middle", correct: false, feedback: "Site B có băng nước nhưng nằm trong vùng bóng dài." },
        ] },
      { kind: "multipleChoice",
        prompt: "Why is Site C stronger than choosing the sunniest site alone?",
        vi: "Vì sao Site C tốt hơn việc chỉ chọn nơi nhiều nắng nhất?",
        options: ["It balances light with water, level terrain, energy, and access", "It has the largest letter", "It is closest to Earth in the sky"],
        answer: "It balances light with water, level terrain, energy, and access",
        explainVi: "Quyết định hệ thống cần xem nhiều tiêu chí cùng lúc thay vì tối ưu một chỉ số duy nhất." },
      { kind: "arrangeSentence",
        prompt: "Present the recommendation:",
        vi: "Trình bày khuyến nghị:",
        solution: ["Site", "C", "is", "the", "best", "choice", "because", "it", "meets", "all", "requirements"],
        say: "Site C is the best choice because it meets all requirements.",
        explainVi: "Because nối khuyến nghị với lý do tổng hợp." },
      { kind: "multipleChoice",
        prompt: "What should the crew do if future data shows a long shadow over Site C?",
        vi: "Đội nên làm gì nếu dữ liệu sau này cho thấy Site C bị bóng che dài?",
        options: ["Review the decision and update the plan", "Ignore the new evidence", "Remove the water requirement"],
        answer: "Review the decision and update the plan",
        explainVi: "Một quyết định dựa trên bằng chứng phải được cập nhật khi bằng chứng quan trọng thay đổi." },
      { kind: "dialogue", who: "stranger", name: "Commander Reyes",
        en: "You did more than complete six tasks. You explained why each decision was safe, useful, and supported by evidence.",
        vi: "Các em không chỉ hoàn thành sáu nhiệm vụ. Các em đã giải thích vì sao mỗi quyết định an toàn, hữu ích và có bằng chứng hỗ trợ." },
      { kind: "clueReveal", title: "Lunar Mission Specialist Badge", itemId: "lunar-mission-specialist-badge",
        en: "The crew approves Site C and seals the habitat report. Maple earns the Lunar Mission Specialist Badge.",
        vi: "Đội duyệt Site C và niêm phong báo cáo căn cứ. Maple nhận Huy hiệu Chuyên gia Nhiệm vụ Mặt Trăng." },
    ],
  },
];

export const SEASON_MISSION_MOONBASE: AdventureSeason = {
  id: "s08",
  title: "Mission Moonbase",
  vi: "Nhiệm vụ Căn cứ Mặt Trăng",
  subtitle: "Phân công đội, làm theo quy trình và dùng dữ liệu để hoàn thành một ngày vận hành căn cứ Mặt Trăng.",
  mapImage: H + "map/season-08-moonbase-map.webp",
  chapters: S08_CHAPTERS,
  items: S08_ITEMS,
  itemsTagline: "Thu thập chín công cụ nhiệm vụ để vận hành căn cứ và chọn vị trí nhà kính mới.",
};
