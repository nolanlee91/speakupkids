...
/* ============================================================================
 * SEASON 07 — THE JUNIOR NEWSROOM: FACT OR RUMOUR?
 * Media literacy: claim → image context → witness viewpoint → primary source →
 * fair headline → evidence-based report.
 * ==========================================================================*/
const G = "/assets/images/adventure/season-07-junior-newsroom/";

const S07_ITEMS: AdventureItem[] = [
  { id: "junior-reporter-pass", name: "Junior Reporter Pass", vi: "Thẻ phóng viên trẻ", emoji: "🎟️", image: G + "items/junior-reporter-pass.webp" },
  { id: "anonymous-claim-card", name: "Anonymous Claim Card", vi: "Thẻ tin chưa rõ nguồn", emoji: "❓", image: G + "items/anonymous-claim-card.webp" },
  { id: "full-playground-photo", name: "Full Playground Photo", vi: "Ảnh toàn cảnh sân chơi", emoji: "📷", image: G + "items/full-playground-photo.webp" },
  { id: "interview-notebook", name: "Interview Notebook", vi: "Sổ phỏng vấn", emoji: "📓", image: G + "items/interview-notebook.webp" },
  { id: "voice-recorder", name: "Voice Recorder", vi: "Máy ghi âm", emoji: "🎙️", image: G + "items/voice-recorder.webp" },
  { id: "official-repair-notice", name: "Official Repair Notice", vi: "Thông báo sửa chữa chính thức", emoji: "📄", image: G + "items/official-repair-notice.webp" },
  { id: "source-checklist", name: "Source Checklist", vi: "Danh sách kiểm tra nguồn", emoji: "✅", image: G + "items/source-checklist.webp" },
  { id: "accurate-headline-card", name: "Accurate Headline Card", vi: "Thẻ tiêu đề chính xác", emoji: "📰", image: G + "items/accurate-headline-card.webp" },
  { id: "young-fact-checker-badge", name: "Young Fact Checker Badge", vi: "Huy hiệu Kiểm chứng viên Trẻ", emoji: "🏅", image: G + "items/young-fact-checker-badge.webp" },
];

const S07_CHAPTERS: AdventureChapter[] = [
  {
    id: "s07-ch01", seasonId: "s07", chapterNumber: 1,
    title: "The Message Everyone Shared", vi: "Tin nhắn ai cũng chia sẻ",
    shortDescription: "Một tin nhắn nói sân chơi sắp bị đóng vĩnh viễn đang lan rất nhanh. Maple phải xác định điều gì đã biết và điều gì vẫn chưa được kiểm chứng.",
    estimatedMinutes: 6,
    node: { x: 18, y: 72, key: "youth-newsroom" },
    sceneImage: G + "chapters/chapter-01-message-everyone-shared.webp",
    nextChapterId: "s07-ch02",
    reward: {
      stars: 3, itemId: "anonymous-claim-card", extraItemIds: ["junior-reporter-pass"],
      clueTitle: "Anonymous Claim Card",
      clueVi: "Tin nhắn được chia sẻ nhiều lần nhưng không ghi tác giả, nguồn hay bằng chứng ban đầu.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Nia",
        en: "This message has spread across the neighbourhood. It says the playground will close forever, but I cannot find the original source.",
        vi: "Tin nhắn này đã lan khắp khu phố. Nó nói sân chơi sẽ đóng vĩnh viễn, nhưng mình không tìm thấy nguồn ban đầu." },
      { kind: "dialogue", who: "maple",
        en: "A popular claim is not automatically a fact. Let us separate what the message says from what it proves.",
        vi: "Một lời khẳng định phổ biến không tự động trở thành sự thật. Hãy tách điều tin nhắn nói khỏi điều nó chứng minh." },
      { kind: "observation",
        prompt: "What happens to the original playground message on the display?",
        vi: "Điều gì xảy ra với tin nhắn sân chơi ban đầu trên màn hình?",
        options: [
          { label: "It is copied and shared many times", correct: true, feedback: "Đúng! Một thẻ ban đầu lan thành rất nhiều bản sao." },
          { label: "It changes into an official notice", correct: false, feedback: "Các bản sao vẫn là cùng một tin chưa rõ nguồn." },
          { label: "It disappears immediately", correct: false, feedback: "Tin nhắn đang lan rộng chứ không biến mất." },
        ] },
      { kind: "multipleChoice",
        prompt: "Which missing detail makes the claim difficult to verify?",
        vi: "Chi tiết bị thiếu nào khiến lời khẳng định khó kiểm chứng?",
        options: ["The original source", "The colour of the message card", "The number of people who shared it"],
        answer: "The original source",
        explainVi: "Nguồn ban đầu cho biết ai đưa ra thông tin và dựa trên bằng chứng nào; số lượt chia sẻ không chứng minh độ chính xác." },
      { kind: "arrangeSentence",
        prompt: "Maple describes the claim carefully:",
        vi: "Maple mô tả lời khẳng định một cách thận trọng:",
        solution: ["The", "message", "may", "be", "true", "but", "it", "is", "not", "verified"],
        say: "The message may be true, but it is not verified.",
        explainVi: "May thể hiện khả năng, còn but nhấn mạnh rằng chưa có xác nhận." },
      { kind: "clueReveal", title: "Anonymous Claim Card", itemId: "anonymous-claim-card",
        en: "Nia gives Maple a reporter pass and saves the original claim card. Its only evidence is a tightly cropped photograph.",
        vi: "Nia trao cho Maple thẻ phóng viên và lưu thẻ tin ban đầu. Bằng chứng duy nhất của nó là một bức ảnh bị cắt rất sát." },
    ],
  },
  {
    id: "s07-ch02", seasonId: "s07", chapterNumber: 2,
    title: "The Cropped Photograph", vi: "Bức ảnh bị cắt",
    shortDescription: "Một khung ảnh chỉ cho thấy rào chắn, còn ảnh toàn cảnh cho thấy phần lớn sân chơi vẫn mở. Maple kiểm tra cách ngữ cảnh thay đổi ý nghĩa.",
    estimatedMinutes: 7,
    node: { x: 32, y: 31, key: "waterfront-playground" },
    sceneImage: G + "chapters/chapter-02-cropped-photograph.webp",
    nextChapterId: "s07-ch03",
    reward: {
      stars: 3, itemId: "full-playground-photo",
      clueTitle: "Full Playground Photo",
      clueVi: "Ảnh đầy đủ cho thấy rào chắn chỉ bao quanh một khu sửa chữa nhỏ; phần còn lại vẫn hoạt động.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Mr. Chen",
        en: "Both pictures came from the same camera. The first one shows only the barrier. The second includes the rest of the playground.",
        vi: "Cả hai ảnh đều từ cùng một máy ảnh. Ảnh đầu chỉ cho thấy rào chắn. Ảnh thứ hai bao gồm phần còn lại của sân chơi." },
      { kind: "observation",
        prompt: "What important detail appears in the wider photograph?",
        vi: "Chi tiết quan trọng nào xuất hiện trong ảnh rộng hơn?",
        options: [
          { label: "Families are using the open part of the playground", correct: true, feedback: "Chính xác! Ảnh rộng cho thấy sân chơi không đóng toàn bộ." },
          { label: "The whole park is empty", correct: false, feedback: "Có nhiều gia đình và trẻ em trong khu đang mở." },
          { label: "Every play structure has been removed", correct: false, feedback: "Các thiết bị vui chơi vẫn còn và đang được sử dụng." },
        ] },
      { kind: "multipleChoice",
        prompt: "Why can the cropped photograph create a misleading impression?",
        vi: "Vì sao ảnh bị cắt có thể tạo ấn tượng sai?",
        options: ["It hides the open area outside the frame", "It was taken with a professional camera", "The barrier is orange"],
        answer: "It hides the open area outside the frame",
        explainVi: "Ảnh cắt không nhất thiết giả, nhưng việc loại bỏ ngữ cảnh có thể khiến người xem hiểu sai toàn bộ tình huống." },
      { kind: "arrangeSentence",
        prompt: "Compare the two frames:",
        vi: "So sánh hai khung ảnh:",
        solution: ["The", "cropped", "photo", "shows", "less", "than", "the", "full", "photo"],
        say: "The cropped photo shows less than the full photo.",
        explainVi: "Less than dùng để so sánh lượng thông tin trong hai khung ảnh." },
      { kind: "multipleChoice",
        prompt: "What should a careful reporter do before sharing a dramatic image?",
        vi: "Một phóng viên cẩn thận nên làm gì trước khi chia sẻ một hình ảnh gây chú ý?",
        options: ["Check the full image and its context", "Add a stronger warning symbol", "Assume the caption is correct"],
        answer: "Check the full image and its context",
        explainVi: "Kiểm tra ảnh gốc, thời gian, địa điểm và phần nằm ngoài khung giúp tránh kết luận sai." },
      { kind: "clueReveal", title: "Full Playground Photo", itemId: "full-playground-photo",
        en: "The full frame weakens the closure rumour. Two people nearby saw the repair truck, but from different positions.",
        vi: "Ảnh toàn cảnh làm tin đồn đóng cửa kém thuyết phục. Hai người gần đó đã thấy xe sửa chữa nhưng từ hai vị trí khác nhau." },
    ],
  },
  {
    id: "s07-ch03", seasonId: "s07", chapterNumber: 3,
    title: "Two Witnesses, Two Versions", vi: "Hai nhân chứng, hai phiên bản",
    shortDescription: "Hai người kể khác nhau vì họ đứng ở hai vị trí khác nhau. Maple phải ghi chính xác điều mỗi người nhìn thấy và giới hạn trong lời kể.",
    estimatedMinutes: 7,
    node: { x: 66, y: 24, key: "interview-pavilion" },
    sceneImage: G + "chapters/chapter-03-two-witnesses.webp",
    nextChapterId: "s07-ch04",
    reward: {
      stars: 3, itemId: "interview-notebook", extraItemIds: ["voice-recorder"],
      clueTitle: "Interview Notebook",
      clueVi: "Cuốn sổ ghi lại lời kể, vị trí quan sát và phần mỗi nhân chứng không thể nhìn thấy.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Mrs. Green",
        en: "I was beside the garden. I saw workers unloading blue safety mats near the slide.",
        vi: "Tôi đứng cạnh khu vườn. Tôi thấy công nhân dỡ những tấm thảm an toàn màu xanh gần cầu trượt." },
      { kind: "dialogue", who: "stranger", name: "Luis",
        en: "I was running on the opposite path. I saw the truck and barrier, but the trees blocked the cargo.",
        vi: "Tôi chạy ở lối đối diện. Tôi thấy xe tải và rào chắn, nhưng cây cối che mất hàng trên xe." },
      { kind: "observation",
        prompt: "What do the two viewpoint diagrams show?",
        vi: "Hai sơ đồ góc nhìn cho thấy điều gì?",
        options: [
          { label: "The witnesses viewed the repair area from different directions", correct: true, feedback: "Đúng! Các đường nhìn màu khác nhau xuất phát từ hai vị trí." },
          { label: "Both witnesses stood in exactly the same place", correct: false, feedback: "Hai sơ đồ thể hiện hai vị trí riêng biệt." },
          { label: "Neither witness could see the park", correct: false, feedback: "Cả hai đều thấy một phần khu sửa chữa." },
        ] },
      { kind: "multipleChoice",
        prompt: "Do the two accounts necessarily contradict each other?",
        vi: "Hai lời kể có nhất thiết mâu thuẫn nhau không?",
        options: ["No, each person could see a different part of the same event", "Yes, only one witness can ever be correct", "Yes, because one person was running"],
        answer: "No, each person could see a different part of the same event",
        explainVi: "Góc nhìn khác nhau có thể tạo ra thông tin bổ sung, không nhất thiết loại trừ nhau." },
      { kind: "arrangeSentence",
        prompt: "Report the limitation accurately:",
        vi: "Tường thuật giới hạn quan sát chính xác:",
        solution: ["Luis", "saw", "the", "truck", "but", "not", "what", "it", "carried"],
        say: "Luis saw the truck, but not what it carried.",
        explainVi: "But phân biệt điều nhân chứng quan sát được với phần nằm ngoài tầm nhìn." },
      { kind: "clueReveal", title: "Interview Notebook", itemId: "interview-notebook",
        en: "Together, the accounts suggest a small safety repair. Maple still needs a primary source that confirms the purpose and dates.",
        vi: "Kết hợp hai lời kể cho thấy có một đợt sửa chữa an toàn nhỏ. Maple vẫn cần nguồn gốc xác nhận mục đích và thời gian." },
    ],
  },
  {
    id: "s07-ch04", seasonId: "s07", chapterNumber: 4,
    title: "The Official Notice", vi: "Thông báo chính thức",
    shortDescription: "Tại trung tâm thông tin, Maple tìm thấy tài liệu gốc ghi rõ khu sửa chữa, thời gian ba ngày và kế hoạch mở lại.",
    estimatedMinutes: 7,
    node: { x: 51, y: 58, key: "information-centre" },
    sceneImage: G + "chapters/chapter-04-official-notice.webp",
    nextChapterId: "s07-ch05",
    reward: {
      stars: 3, itemId: "official-repair-notice", extraItemIds: ["source-checklist"],
      clueTitle: "Official Repair Notice",
      clueVi: "Tài liệu gốc xác nhận chỉ một khu nhỏ đóng trong ba ngày để thay thảm an toàn rồi mở lại.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Mr. Hassan",
        en: "This is the original repair notice. Check who issued it, what area it covers, and when the work ends.",
        vi: "Đây là thông báo sửa chữa gốc. Hãy kiểm tra đơn vị phát hành, khu vực áp dụng và thời điểm công việc kết thúc." },
      { kind: "observation",
        prompt: "Which details are shown together on the official notice?",
        vi: "Những chi tiết nào được thể hiện cùng nhau trên thông báo chính thức?",
        options: [
          { label: "Three calendar days, safety mats, and a reopen arrow", correct: true, feedback: "Đúng! Ba biểu tượng kết hợp thành một kế hoạch sửa chữa có thời hạn." },
          { label: "A permanent closure and removed equipment", correct: false, feedback: "Thông báo có mũi tên mở lại và thiết bị vẫn còn." },
          { label: "A new parking lot covering the whole park", correct: false, feedback: "Không có biểu tượng bãi đỗ xe trên tài liệu." },
        ] },
      { kind: "multipleChoice",
        prompt: "Why is this notice stronger evidence than the anonymous message?",
        vi: "Vì sao thông báo này là bằng chứng mạnh hơn tin nhắn ẩn danh?",
        options: ["It identifies the project, dates, area, and issuing source", "It uses warmer colours", "It has a larger sheet of paper"],
        answer: "It identifies the project, dates, area, and issuing source",
        explainVi: "Bằng chứng mạnh có nguồn xác định và chi tiết có thể kiểm tra độc lập." },
      { kind: "arrangeSentence",
        prompt: "Summarize the confirmed information:",
        vi: "Tóm tắt thông tin đã xác nhận:",
        solution: ["According", "to", "the", "notice", "the", "repair", "will", "take", "three", "days"],
        say: "According to the notice, the repair will take three days.",
        explainVi: "According to dùng để chỉ rõ nguồn của thông tin được tường thuật." },
      { kind: "multipleChoice",
        prompt: "Which part of the original rumour is false?",
        vi: "Phần nào trong tin đồn ban đầu là sai?",
        options: ["The playground will close forever", "A small repair area has a barrier", "Workers brought materials to the park"],
        answer: "The playground will close forever",
        explainVi: "Rào chắn và công nhân là có thật, nhưng tài liệu xác nhận việc đóng chỉ tạm thời và giới hạn ở một khu." },
      { kind: "clueReveal", title: "Source Checklist", itemId: "source-checklist",
        en: "Maple checks the issuer, date, scope, and supporting evidence. Now the team can replace the rumour with a fair headline.",
        vi: "Maple kiểm tra đơn vị phát hành, ngày, phạm vi và bằng chứng hỗ trợ. Giờ nhóm có thể thay tin đồn bằng một tiêu đề công bằng." },
    ],
  },
  {
    id: "s07-ch05", seasonId: "s07", chapterNumber: 5,
    title: "Rewrite the Headline", vi: "Viết lại tiêu đề",
    shortDescription: "Ba tiêu đề tạo ba ấn tượng khác nhau. Maple chọn tiêu đề nói đúng phạm vi, thời gian và kế hoạch mở lại.",
    estimatedMinutes: 7,
    node: { x: 83, y: 73, key: "editing-suite" },
    sceneImage: G + "chapters/chapter-05-rewrite-headline.webp",
    nextChapterId: "s07-ch06",
    reward: {
      stars: 3, itemId: "accurate-headline-card",
      clueTitle: "Accurate Headline Card",
      clueVi: "Tiêu đề mới nêu rõ một khu sửa chữa nhỏ, thời hạn ba ngày và việc sân chơi sẽ mở lại.",
    },
    storySteps: [
      { kind: "dialogue", who: "stranger", name: "Nia",
        en: "A headline should be clear enough to understand, but not stronger than the evidence.",
        vi: "Tiêu đề cần đủ rõ để hiểu, nhưng không được khẳng định mạnh hơn bằng chứng." },
      { kind: "observation",
        prompt: "Which headline card includes the repair barrier, calendar, and reopen arrow?",
        vi: "Thẻ tiêu đề nào có cả rào sửa chữa, lịch và mũi tên mở lại?",
        options: [
          { label: "The card on the right", correct: true, feedback: "Đúng! Thẻ bên phải chứa đủ phạm vi, thời gian và kết quả." },
          { label: "The dramatic crossed-out card on the left", correct: false, feedback: "Thẻ đó gợi ý đóng vĩnh viễn, trái với tài liệu gốc." },
          { label: "The question-mark card in the middle", correct: false, feedback: "Thẻ giữa quá mơ hồ và không cung cấp thông tin đã xác nhận." },
        ] },
      { kind: "multipleChoice",
        prompt: "Which written headline best matches the verified evidence?",
        vi: "Tiêu đề nào phù hợp nhất với bằng chứng đã kiểm chứng?",
        options: [
          "Small playground area closes for three-day safety repair",
          "Playground disappears forever!",
          "Something may happen at the park",
        ],
        answer: "Small playground area closes for three-day safety repair",
        explainVi: "Tiêu đề chính xác nêu phạm vi nhỏ, thời gian cụ thể và mục đích sửa chữa." },
      { kind: "arrangeSentence",
        prompt: "Add the reopening information:",
        vi: "Bổ sung thông tin mở lại:",
        solution: ["The", "full", "playground", "will", "reopen", "after", "the", "repair"],
        say: "The full playground will reopen after the repair.",
        explainVi: "After nối việc mở lại với thời điểm công việc sửa chữa hoàn tất." },
      { kind: "multipleChoice",
        prompt: "Why is a vague question headline still unhelpful after facts are confirmed?",
        vi: "Vì sao tiêu đề dạng câu hỏi mơ hồ vẫn không hữu ích sau khi đã xác nhận sự thật?",
        options: ["It hides useful confirmed details", "Questions are never allowed in English", "It makes the photograph wider"],
        answer: "It hides useful confirmed details",
        explainVi: "Khi đã có dữ liệu rõ ràng, tiêu đề nên truyền đạt chúng thay vì tiếp tục tạo nghi ngờ không cần thiết." },
      { kind: "clueReveal", title: "Accurate Headline Card", itemId: "accurate-headline-card",
        en: "The fair headline is ready. Maple and Nia carry the evidence sequence upstairs to the live studio.",
        vi: "Tiêu đề công bằng đã sẵn sàng. Maple và Nia mang chuỗi bằng chứng lên studio trực tiếp." },
    ],
  },
  {
    id: "s07-ch06", seasonId: "s07", chapterNumber: 6,
    title: "Live from the Newsroom", vi: "Trực tiếp từ phòng tin",
    shortDescription: "Maple trình bày bản tin cuối bằng cách nối lời khẳng định, ảnh đầy đủ, lời nhân chứng và tài liệu gốc thành một kết luận minh bạch.",
    estimatedMinutes: 8,
    node: { x: 86, y: 22, key: "broadcast-studio" },
    sceneImage: G + "chapters/chapter-06-live-newsroom.webp",
    reward: {
      stars: 3, itemId: "young-fact-checker-badge",
      clueTitle: "Young Fact Checker Badge",
      clueVi: "Maple nhận huy hiệu vì đã kiểm tra nguồn, giữ ngữ cảnh và sửa thông tin sai bằng bằng chứng.",
    },
    storySteps: [
      { kind: "dialogue", who: "narrator",
        en: "The evidence screen follows the investigation from the full photograph to the official repair calendar and reopening plan.",
        vi: "Màn hình bằng chứng theo hành trình điều tra từ ảnh đầy đủ tới lịch sửa chữa chính thức và kế hoạch mở lại." },
      { kind: "observation",
        prompt: "What does the final green check on the studio screen represent?",
        vi: "Dấu kiểm xanh cuối cùng trên màn hình studio đại diện cho điều gì?",
        options: [
          { label: "The conclusion is supported by checked evidence", correct: true, feedback: "Đúng! Dấu kiểm xuất hiện sau chuỗi ảnh, nhân chứng và tài liệu." },
          { label: "The rumour received many shares", correct: false, feedback: "Số lượt chia sẻ không nằm trong chuỗi kết luận cuối." },
          { label: "The playground will never reopen", correct: false, feedback: "Bằng chứng cho thấy sân chơi sẽ mở lại sau sửa chữa." },
        ] },
      { kind: "multipleChoice",
        prompt: "Which opening gives viewers the most accurate summary?",
        vi: "Câu mở đầu nào tóm tắt chính xác nhất cho người xem?",
        options: [
          "The playground remains open except for one repair area, which will reopen after three days.",
          "A viral message proves the whole park is closing.",
          "No one knows anything about the playground.",
        ],
        answer: "The playground remains open except for one repair area, which will reopen after three days.",
        explainVi: "Câu này bao gồm phạm vi, trạng thái hiện tại và thời hạn đã xác nhận." },
      { kind: "arrangeSentence",
        prompt: "Explain the correction:",
        vi: "Giải thích việc đính chính:",
        solution: ["The", "rumour", "spread", "because", "the", "photo", "lost", "its", "context"],
        say: "The rumour spread because the photo lost its context.",
        explainVi: "Because giới thiệu nguyên nhân khiến người xem hiểu sai tình huống." },
      { kind: "multipleChoice",
        prompt: "What should viewers do when they meet a similar claim online?",
        vi: "Người xem nên làm gì khi gặp lời khẳng định tương tự trên mạng?",
        options: ["Pause, check the source, and look for full context", "Share it first and check later", "Trust it if a friend sent it"],
        answer: "Pause, check the source, and look for full context",
        explainVi: "Ba bước ngắn này làm chậm sự lan truyền của tin sai và giúp đánh giá bằng chứng." },
      { kind: "dialogue", who: "maple",
        en: "Correcting a rumour is not about winning an argument. It is about helping people make decisions with better information.",
        vi: "Đính chính tin đồn không phải để thắng một cuộc tranh luận. Đó là giúp mọi người quyết định dựa trên thông tin tốt hơn." },
      { kind: "clueReveal", title: "Young Fact Checker Badge", itemId: "young-fact-checker-badge",
        en: "The report goes live with its sources and context intact. Maple earns the Young Fact Checker Badge.",
        vi: "Bản tin lên sóng với nguồn và ngữ cảnh đầy đủ. Maple nhận Huy hiệu Kiểm chứng viên Trẻ." },
    ],
  },
];

export const SEASON_JUNIOR_NEWSROOM: AdventureSeason = {
  id: "s07",
  title: "The Junior Newsroom: Fact or Rumour?",
  vi: "Phòng tin Trẻ: Sự thật hay Tin đồn?",
  subtitle: "Theo dấu một tin lan truyền, kiểm tra ảnh và nguồn gốc rồi xây dựng bản tin dựa trên bằng chứng.",
  mapImage: G + "map/season-07-newsroom-city-map.webp",
  chapters: S07_CHAPTERS,
  items: S07_ITEMS,
  itemsTagline: "Thu thập chín công cụ để kiểm tra nguồn, giữ đúng ngữ cảnh và hoàn thành bản tin đáng tin cậy.",
};
