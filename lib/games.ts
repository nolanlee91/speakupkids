...
export const WORLDS: World[] = [
  {
    ...
    stops: [
      { id: "et1", kind: "picdet", ref: "pd-park", label: "Park Detective", vi: "Thám tử công viên", sticker: "st-detective" },
      { id: "et2", kind: "riddle", ref: "riddle-animals", label: "Animal Riddles", vi: "Đố vui con vật", sticker: "st-owl" },
      { id: "et3", kind: "puzzle", ref: "puzzle-everyday", label: "Sentence Puzzle", vi: "Xếp câu", sticker: "st-puzzle" },
      { id: "et4", kind: "talk", ref: "pt-park", label: "Picture Talk", vi: "Mô tả công viên", sticker: "st-star" },
